...
- 148 systems (5.3%) show "Not Assessed" from SAFER — including LADWP (7.7M served). Need derived status from MCL data.
- meta.json with processing date/counts is generated by pipeline but not yet displayed in UI
